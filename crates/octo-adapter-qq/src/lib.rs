//! QQ Official Bot adapter for DOT (RFC-0850 S8.1, PlatformType::QQ)
//!
//! Bridges DOT envelopes to QQ via the QQ Official Bot API.
//!
//! ## Configuration
//!
//! ```json
...
impl QQAdapter {
    ...
    pub fn domain_hash(group_id: &str) -> [u8; 32] {
        *blake3::hash(format!("qq:{}", group_id.trim().to_lowercase()).as_bytes()).as_bytes()
    }
