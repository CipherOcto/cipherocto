...
pub mod community_get_linked_groups_participants;
pub mod community_get_subgroup_participant_counts;
pub mod community_get_subgroups;
pub mod community_join_subgroup;
pub mod community_link_subgroups;
pub mod community_query_linked_group;
...
pub mod newsletter_get_messages;
pub mod newsletter_get_metadata;
pub mod newsletter_get_metadata_by_invite;
...
pub mod newsletter_set_admin_mute;
pub mod newsletter_set_follower_mute;
pub mod newsletter_subscribe_live_updates;
pub mod newsletter_update;
...
fn build_base_registry() -> HandlerRegistry {
    HandlerRegistry::new()
        ...
        .register(Arc::new(events::EventsUnknownStatsHistory))
...
mod tests {
    ...
    fn registry_size_matches_phase1_phase2() {
        ...
        let dedup = PHASE1_METHODS
            ...
            .len();
        // 3 RPCs added for the events first-class overhaul:
        // events.list_kinds + events.unknown_stats +
        // events.unknown_stats.history.
        assert_eq!(reg.methods().len(), dedup + 3);
    }
}
