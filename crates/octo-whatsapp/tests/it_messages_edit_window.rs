//! Integration test for the `messages.edit` 3600s edit-window.
//!
//! `msg_timestamp = now - 7200` (2 hours ago) is past the window. The
//! handler must return `-32013 EditWindowExpired` before any adapter
//! contact.
...
async fn messages_edit_expired_window_returns_minus_32013() {
