...
mod tests {
    ...
    fn test_supported_models() {
        ...
        assert!(models.contains(&"llama-3.1-70b-versatile"));
        assert!(models.contains(&"mixtral-8x7b-32768"));
    }

    #[test]
    fn test_supports_streaming() {
        assert!(GroqProvider::new().supports_streaming());
    }
    ...
    fn test_routing_weight() {
        assert_eq!(GroqProvider::new().routing_weight(), 7);
    }

    #[test]
    fn test_supports_model() {
        let p = GroqProvider::new();
        assert!(p.supports_model("llama-3.1-70b-versatile"));
