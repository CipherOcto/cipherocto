// ai21 — AI21 Python SDK via PyO3 (INTERNAL boundary #1 per RFC-0917)
//
...
fn convert_response(
    ...
    let model_str: String = py_obj
        ...
        .extract()
        .unwrap_or_else(|_| "ai21".to_string());
