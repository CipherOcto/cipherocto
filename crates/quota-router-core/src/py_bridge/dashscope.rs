// dashscope — Alibaba DashScope via PyO3
//
// This module calls the official DashScope Python SDK via PyO3.
...
/// DashScope provider via official Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl DashScopeProvider {
    ...
    /// Call DashScope completion via Python SDK
    pub fn completion(
        &self,
        model: &str,
        ...
        Python::with_gil(|py| {
            // Import OpenAI SDK (DashScope is compatible with OpenAI API)
            ...
            // Create client with DashScope base URL
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for DashScopeProvider {
    fn name(&self) -> &str {
        "dashscope"
    }
