// deepinfra — DeepInfra via OpenAI Python SDK with custom base_url (INTERNAL boundary #1 per RFC-0917)
//
// This module calls DeepInfra using the OpenAI Python SDK with a custom base_url.
...
/// DeepInfra provider via OpenAI Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl DeepInfraProvider {
    ...
    pub fn completion(
        ...
        Python::with_gil(|py| {
            ...
            // Create client with DeepInfra base_url
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for DeepInfraProvider {
    fn name(&self) -> &str {
        "deepinfra"
    }
