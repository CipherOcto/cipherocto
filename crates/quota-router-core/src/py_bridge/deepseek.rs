// deepseek — DeepSeek Python SDK via PyO3 (INTERNAL boundary #1 per RFC-0917)
//
// This module calls the official DeepSeek Python SDK via PyO3.
...
/// DeepSeek provider via official Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl crate::py_bridge::openai::PyBridgeProvider for DeepSeekProvider {
    fn name(&self) -> &str {
        "deepseek"
    }
