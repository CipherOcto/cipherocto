// fireworks — Fireworks AI via OpenAI Python SDK with custom base_url (INTERNAL boundary #1 per RFC-0917)
//
// This module calls the Fireworks AI API via the OpenAI Python SDK with custom base_url.
// It is called by python_sdk_entry (EXTERNAL boundary #2).
//
// Per RFC-0917 lines 220-221:
// "Fireworks | `openai` Python SDK with custom base_url | OpenAI-compatible API"
...
/// Fireworks AI provider via OpenAI Python SDK with custom base_url
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl FireworksProvider {
    ...
    /// Call Fireworks AI completion via OpenAI Python SDK with custom base_url
    pub fn completion(
        &self,
        model: &str,
        ...
        Python::with_gil(|py| {
            ...
            // Create client with custom base_url for Fireworks
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for FireworksProvider {
    fn name(&self) -> &str {
        "fireworks"
    }
