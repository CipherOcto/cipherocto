// groq — Groq Python SDK via PyO3 (INTERNAL boundary #1 per RFC-0917)
//
// This module calls the official Groq Python SDK via PyO3.
...
/// Groq provider via official Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl crate::py_bridge::openai::PyBridgeProvider for GroqProvider {
    fn name(&self) -> &str {
        "groq"
    }
