// inception — Inception AI via PyO3 (INTERNAL boundary #1 per RFC-0917)
//
// This module calls the Inception AI API via PyO3 using OpenAI SDK.
...
/// Inception AI provider via OpenAI-compatible Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl InceptionProvider {
    ...
    /// Call Inception AI completion via Python SDK
    pub fn completion(
        &self,
        model: &str,
        ...
        let api_base = self
            .api_base
            .as_deref()
            .unwrap_or("https://inception.ai/api/v1");

        Python::with_gil(|py| {
            // Import OpenAI SDK (Inception AI uses OpenAI-compatible API)
            ...
            // Create client with Inception AI base_url
