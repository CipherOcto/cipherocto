// minimax — MiniMax via PyO3
//
// This module calls the official MiniMax Python SDK via PyO3.
...
/// MiniMax provider via official Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl MiniMaxProvider {
    ...
    /// Call MiniMax completion via Python SDK
    pub fn completion(
        &self,
        model: &str,
        ...
        Python::with_gil(|py| {
            // Import OpenAI SDK (MiniMax is compatible with OpenAI API)
            ...
            // Create client with MiniMax base URL
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for MiniMaxProvider {
    fn name(&self) -> &str {
        "minimax"
    }
