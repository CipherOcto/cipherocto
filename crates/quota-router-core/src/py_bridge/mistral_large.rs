// mistral_large — via OpenAI SDK via PyO3 (INTERNAL boundary #1 per RFC-0917)
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
pub struct MistralLargeProvider {
    api_key: Option<String>,
    api_base: Option<String>,
}
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl Default for MistralLargeProvider {
    fn default() -> Self {
        Self::new()
    }
}

impl MistralLargeProvider {
    pub fn new() -> Self {
        Self {
            api_key: None,
            api_base: None,
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl crate::py_bridge::openai::PyBridgeProvider for MistralLargeProvider {
    fn name(&self) -> &str {
        "mistral_large"
    }
    fn completion(
