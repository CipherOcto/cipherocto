// moonshot — Moonshot AI via PyO3
//
// This module calls the official Moonshot AI Python SDK via PyO3.
...
/// Moonshot AI provider via official Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl MoonshotProvider {
    ...
    /// Call Moonshot completion via Python SDK
    pub fn completion(
        &self,
        model: &str,
        ...
        Python::with_gil(|py| {
            // Import OpenAI SDK (Moonshot is compatible with OpenAI API)
            ...
            // Create client with Moonshot base URL
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for MoonshotProvider {
    fn name(&self) -> &str {
        "moonshot"
    }
