// nebius — Nebius via OpenAI Python SDK with custom base_url (INTERNAL boundary #1 per RFC-0917)
//
// This module calls Nebius using the OpenAI Python SDK with a custom base_url.
...
/// Nebius provider via OpenAI Python SDK
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
...
impl NebiusProvider {
    ...
    pub fn completion(
        ...
        let api_base = self.api_base.as_deref().unwrap_or("https://api.nebius.ai");
        ...
        Python::with_gil(|py| {
            ...
            // Create client with Nebius base_url
...
#[cfg(any(feature = "any-llm-mode", feature = "full"))]
impl PyBridgeProvider for NebiusProvider {
    fn name(&self) -> &str {
        "nebius"
    }
