...
/// ↔ RFC-0959 §Cache classification). This replaces the prior
...
///
/// v2.0 wire form (RFC-0959 §Wire Format + mission 0959-c1):
...
/// RFC-0959 §Adversary A2 (deliberate separation between
