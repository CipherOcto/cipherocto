    ...
    pub fn new() -> Self {
        Self {
            metadata: ProviderMetadata {
                ...
                documentation_url: "https://docs.azureopenai.com/".to_string(),
                env_api_key: "AZUREOPENAI_API_KEY".to_string(),
                env_api_base: Some("AZUREOPENAI_BASE_URL".to_string()),
                api_base: None,
...
impl LLMProvider for AZUREOPENAIProvider {
    ...
    fn check_packages(&self) -> Result<(), String> {
        Python::with_gil(|py| {
            match PyModule::import(py, "azureopenai") {
                Ok(_) => Ok(()),
