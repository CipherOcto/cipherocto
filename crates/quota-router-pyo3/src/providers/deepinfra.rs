    ...
    pub fn new() -> Self {
        Self {
            metadata: ProviderMetadata {
                ...
                documentation_url: "https://deepinfra.com/docs".to_string(),
                env_api_key: "DEEPINFRA_API_KEY".to_string(),
                env_api_base: Some("DEEPINFRA_BASE_URL".to_string()),
                api_base: Some("https://api.deepinfra.com/v1".to_string()),
