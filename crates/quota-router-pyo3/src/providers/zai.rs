...
impl ZAIProvider {
    pub fn new() -> Self {
        Self {
            metadata: ProviderMetadata {
                name: "zai".to_string(),
                documentation_url: "https://docs.zai.com/".to_string(),
                env_api_key: "ZAI_API_KEY".to_string(),
                env_api_base: Some("ZAI_BASE_URL".to_string()),
                api_base: None,
...
impl LLMProvider for ZAIProvider {
    ...
    fn embedding(&self, _input: &[String], _model: &str) -> Result<EmbeddingsResponse, PyErr> {
        Err(ProviderError::new_err("zai does not support embeddings"))
    }
