...
graph TB
    subgraph TIERS["Partnership Tiers"]
        direction TB
        T1[Strategic<br/>Direct integration<br/>Revenue share]
        T2[Integration<br/>Technical partnership<br/>Co-marketing]
        T3[Community<br/>Referral program<br/>Event sponsorship]
    end

    subgraph REQUIREMENTS["Requirements by Tier"]
        direction TB
        R1[Strategic: Board approval<br/>$1M+ commit]
        R2[Integration: Technical validation<br/>Shared goals]
        R3[Community: Mutual benefit<br/>No formal agreement]
    end
...
```mermaid
stateDiagram-v2
    [*] --> Identification: Target identified
    Identification --> Qualification: Fit assessment
    Qualification --> Outreach: Initial contact
    Outreach --> Discussion: Value exploration
    Discussion --> Term_Sheet: Agreement in principle
    Term_Sheet --> Integration: Technical/business
    Integration --> Launch: Partnership live
    Launch --> Growth: Expansion
    Growth --> Renewal: Ongoing partnership
    Growth --> Sunset: Successful conclusion
```
