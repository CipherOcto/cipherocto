...
```mermaid
graph TB
    subgraph VALUE_PROPOSITION["Value Proposition"]
        direction TB
        V1[Unlocks idle AI capacity<br/>$100B+ market]
        V2[Enables agent economy<br/>New economic layer]
        V3[Breaks vendor lock-in<br/>Enterprise freedom]
        V4[Sovereign infrastructure<br/>Privacy by design]
    end

    style VALUE_PROPOSITION fill:#27ae60
```
...
```mermaid
pie showData
    title OCTO Distribution (10B tokens)
