...
| **`dispatch_map`**     | `model_name → DispatchInfo` per RFC-0929. Per-deployment routing + key resolution.                                                                                                   | RFC-0929, `architecture/quota-router-architecture.md §9.2 Dispatch Flow`                                |
