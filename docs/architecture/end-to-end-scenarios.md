...
sequenceDiagram
    ...
    alt envelope_id seen before
        ...
        SN->>ST: porelay::Registry::update_score(RelayScore {<br/>  gateway_id=attacker_gateway_id,<br/>  penalty=-0.5,<br/>  ..<br/>})
