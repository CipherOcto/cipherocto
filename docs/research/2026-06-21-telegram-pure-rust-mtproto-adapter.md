...
- **The Bot API HTTP transport (out of scope as a _primary_ path;
...
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `send_message(domain, envelope)` | `client.send_message(chat, text)` for ≤4096 chars; `client.send_file(chat, file)` for >4096                                         | The DOT envelope is base64-encoded (URL_SAFE_NO_PAD) and sent as a Telegram message; >4096 chars is uploaded as a file with the encoded envelope as the caption.                                                       |
...
`PlatformAdapter::send_message` already routes to a chat_id
