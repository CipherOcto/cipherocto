...
- [0957-c1 verify-time amendment](mission-0957-c1-verify-time-amendment-status.md) — S6b RFC-0957 v2.1 row + §Verify-Time Extension + §Caveat DSL Extension + TV-0957 22/22 LANDED 2026-08-17 (commit `c9149128`; Round 2 follow-on `4ec9779f` re-scoped TV-16/17 + dropped dead code; Round 4 follow-on reconciled §3.x drift + cleared source phantom §20.6.1 line 1328).
