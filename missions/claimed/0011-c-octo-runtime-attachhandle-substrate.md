...
| TV-AGT22 | `octo agent revoke-attach --session-id <HEX64>` | Revoked session                                              | `RevokeAttachOutput { session_id_hex, process_scoped: true }` (exit 0)  | NEW; per §Sub-step 5 + RFC-0011-c §F.3 (revocation keyed by session_id)                                                                                                                                                                          |
