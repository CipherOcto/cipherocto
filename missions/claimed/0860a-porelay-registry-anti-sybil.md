...
- [x] Sybil detection: identify clusters of gateways with correlated behavior; reuse RFC-0968 weighted-similarity correlation (`WEIGHTED_SIMILARITY_THRESHOLD = 0.60`, amendment 46) as the primary classifier
  — *ground*: `crates/octo-network/src/porelay/anti_sybil.rs:49` `pub const WEIGHTED_SIMILARITY_THRESHOLD: f64 = 0.60;` declared at the porelay crate boundary alongside `crates/octo-reputation/src/constants.rs:96`; `compute_sybil_risk` (anti_sybil.rs:48) classifies gateway clusters against this threshold.
