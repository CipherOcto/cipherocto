...
Closed (Decomposition Spec Band A — 2026-08-06; audit-closure rolled up 2026-08-07). Claimed 2026-08-04 by @mmacedoeu; RFC-0959-A1 acceptance roll-up captured; **3/5 roll-up ACs GREEN** as of 2026-08-07 audit-closure (TV12 roll-up via 0959-b + 0959-c closures, adversary findings A9/A10/A11 roll-up, sub-mission merges roll-up). 2 remaining unchecked ACs are explicit cross-mission deferrals with named owner + target per [[deferred-vs-unspecified]]: AC-3 (phantom type `IdentityKey::from_public_bytes` → RFC-0009-B1 / RFC-0957-A2 full signature promotion, owner @cipherocto, target 2026-09-15); AC-5 (cross-crate compat → sub-mission landings; workspace `--all-features` clippy blocked by `tdlib-rs` feature-conflict, owner @cipherocto, target 2026-09-15). Mission role: spec roll-up + type coverage decomposition + dependency documentation — no new code authored in this mission per BLUEPRINT §Multi-Mission Decomposition.
...
- [x] All 12 RFC-0959-A1 §Test Vectors pass (TV1: Minimal Delivery, TV2: Atomicity Rollback — Bearer Insert Fails, TV3: Atomicity Rollback — Capability Insert Fails, TV4: Gossip Retry, TV5: Backward Compat — Legacy Verifier, TV6: Replay Defense, TV7: Cross-Node Delivery, TV8: Chain Hash Continuity, TV9: Debug Redaction, TV10: Chain-Tip TOCTOU Race, TV11: Idempotency via UNIQUE, TV12: Buyer Identity Binding) → **GREEN roll-up complete** (2026-08-07 audit-closure): 10 vectors (TV1, TV2, TV3, TV5, TV6, TV8, TV9, TV10, TV11, TV12) → `missions/claimed/0959-b-market-delivery-impl.md` (Band A closed 2026-08-06); 2 vectors (TV4, TV7) → `missions/claimed/0959-c-delivery-gossip-integration.md` (Band A closed 2026-08-06, audit-closure rolled up 2026-08-07 with 9/9 ACs GREEN). Roll-up captures accurate state.
- [x] All 5 RFC-0959-A1 §Adversary Analysis findings covered (A9: Delivery-vs-settlement race, A10: Atomicity rollback exploitation, A11: Gossip partition → envelope not received, plus 2 from RFC-0959 base spec preserved) → **GREEN roll-up complete** (2026-08-07 audit-closure): A9 + A10 → `missions/claimed/0959-b-market-delivery-impl.md` (`chain_tip_lock` CAS breaks TOCTOU race + atomicity rollback exploitation); A11 → `missions/claimed/0959-c-delivery-gossip-integration.md` (bounded retry loop defeats gossip partition); 2 RFC-0959 base spec findings preserved unchanged.
- [ ] Phantom type `IdentityKey::from_public_bytes` properly DEFERRED to RFC-0009-B1 / RFC-0957-A2 (working stub per top-level mission 0957-a1) → **DEFERRED to RFC-0009-B1 / RFC-0957-A2 full signature promotion per [[deferred-vs-unspecified]]**. Working stub currently lives at `crates/octo-wallet/src/capability/identity_stub.rs` per top-level mission `missions/claimed/0957-a1-holder-registry.md`; this mission inherits 0957-a1's deferral (0957-a1 AC-3 also defers with same named owner chain). Stub call site at `deliver_at_settlement` per RFC-0959-A1 §Algorithms:phantom_call_site. **Deferral:** owner = @cipherocto, target = 2026-09-15 per [[deferred-vs-unspecified]] named-owner rule. Phantom type chain (RFC-0957-A1 §Phantom Types → RFC-0959-A1 §Algorithms:phantom_call_site → RFC-0969 §Algorithms:phantom_call_site → RFC-0009-B1); full promotion to typed `IdentityKey::from_public_bytes` lands when RFC-0009-B1 substrate (IdentityKey substrate RFC) reaches Accepted.
- [x] Sub-missions 0959-b, 0959-c all merged and ACs flipped → **GREEN roll-up complete** (2026-08-07 audit-closure): `0959-b-market-delivery-impl.md` (Band A closed 2026-08-06 per commit `0ba67943` + `323a115f`); `0959-c-delivery-gossip-integration.md` (Band A closed 2026-08-06, audit-closure rolled up 2026-08-07 with 9/9 ACs GREEN via sub-mission roll-up `0959-c1-gossip-error-variants` + `0959-c2-cross-node-delivery`). Both sub-missions depend on `missions/claimed/0957-c-holder-registry-impl.md` (Band A closed 2026-08-06 per commit `998debbf` + `3edc425c`) + `missions/claimed/0957-e-mint-txn-parameter.md` (Band A closed 2026-08-06 per commit `e05f9639`; audit-closure rolled up 2026-08-07 with 13/15 ACs GREEN).
- [ ] Cross-crate compat: `cargo build --workspace` green; `cargo test --workspace` green; `cargo clippy --workspace --all-targets --all-features -- -D warnings` clean; `cargo fmt --check` clean → **DEFERRED to sub-mission landings per [[deferred-vs-unspecified]]**: surfaces when 0959-b + 0959-c implementations land; not in scope for this spec-only mission. **Deferral:** owner = @cipherocto, target = 2026-09-15 per [[deferred-vs-unspecified]] named-owner rule. Cross-crate workspace `--all-features` clippy remains blocked by pre-existing unrelated `tdlib-rs` feature-conflict (same as `0957-c` AC #3, `0957-a1` AC #4); package-scoped clippy on touched crates (`octo-wallet`) clean. Tracked as infra-hygiene follow-up.
