...
**Cross-crate compat:** 4/4 sub-points GREEN (verified 2026-08-07 via `missions/claimed/0969-a2-followup.md` §Verification artifacts + workspace-exclude commit `b99b1709`): `cargo build --workspace` (2m 34s); `cargo test --workspace --lib` green; `cargo fmt --check` clean; `cargo clippy --workspace --all-targets --features full -- -D warnings` green (2m 10s).
