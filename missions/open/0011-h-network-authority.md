...
CLI surface for `octo network authority show/rotate` (rotate BLOCKED pending G8). Per RFC-0011-h §Implementation Phases Phase 2.
...
- `0011-h-s-a-seed-list-authority-rotate` — must close before this CLI mission opens
