# 0011-h-s-a-coordinator-record-loader — Substrate additions for CoordinatorRecord::load(coordinator_id)

## Status

Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G12b
...
Loader façade for CoordinatorRecord. Pre-requisite for `octo network coordinator show`.
...
- [ ] Substrate additions land in `crates/octo-coordinator-types/src/state.rs` per RFC-0011-h §Substrate-Additions row G12b
