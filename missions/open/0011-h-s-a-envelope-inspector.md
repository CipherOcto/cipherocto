# 0011-h-s-a-envelope-inspector — Substrate additions for EnvelopeInspector::inspect

## Status

Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G16a

## RFC

RFC-0011-h §Substrate-Additions Companion Missions row G16a

## Summary

Required by `octo network envelope inspect` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/mon/envelope_inspector.rs (NEW)
inspector
```
...
- [ ] Substrate additions land in `crates/octo-network/src/mon/envelope_inspector.rs (NEW)` per RFC-0011-h §Substrate-Additions row G16a
