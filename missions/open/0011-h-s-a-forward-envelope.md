# 0011-h-s-a-forward-envelope — Substrate additions for ForwardEnvelope builder
...
Required by `octo network envelope forward` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/mon/forward_envelope.rs (NEW)
envelope
```
