# 0011-h-s-a-gossip-stats — Substrate additions for Gossip::stats() impl
...
RFC-0011-h §Substrate-Additions Companion Missions row G15

## Summary

Substrate-side anti-entropy counter. Required by `octo network gossip --stats` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/mon/gossip.rs (NEW)
stats
```
...
- [ ] Substrate additions land in `crates/octo-network/src/mon/gossip.rs (NEW)` per RFC-0011-h §Substrate-Additions row G15
