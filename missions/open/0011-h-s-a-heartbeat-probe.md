# 0011-h-s-a-heartbeat-probe — Substrate additions for Heartbeat::probe impl

## Status

Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G17

## RFC

RFC-0011-h §Substrate-Additions Companion Missions row G17

## Summary

Required by `octo network heartbeat` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/mon/heartbeat.rs (NEW)
probe
```
...
- [ ] Substrate additions land in `crates/octo-network/src/mon/heartbeat.rs (NEW)` per RFC-0011-h §Substrate-Additions row G17
