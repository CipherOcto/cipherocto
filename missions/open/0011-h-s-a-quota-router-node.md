...
Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G10
...
Substrate-additions per RFC-0870 Distributed Quota Router Network. Required by `octo network router status/peers` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/quota/router_node.rs (NEW)
node
```
...
- [ ] Substrate additions land in `crates/octo-network/src/quota/router_node.rs (NEW)` per RFC-0011-h §Substrate-Additions row G10
