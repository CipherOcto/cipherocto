...
Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G13
...
RFC-0860 substrate deliverable. Required by `octo network reputation show/list` (deferred).

### Substrate additions target

```rust
// crates/octo-reputation/src/store.rs (NEW)
store
```
...
- [ ] Substrate additions land in `crates/octo-reputation/src/store.rs (NEW)` per RFC-0011-h §Substrate-Additions row G13
