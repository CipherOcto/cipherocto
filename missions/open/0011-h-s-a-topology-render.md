# 0011-h-s-a-topology-render — Substrate additions for Topology struct + render impl

## Status

Open (2026-09-18) — Substrate-additions prerequisite per RFC-0011-h §Substrate-Additions Companion Missions row G14

## RFC

RFC-0011-h §Substrate-Additions Companion Missions row G14

## Summary

Required by `octo network topology` (deferred).

### Substrate additions target

```rust
// crates/octo-network/src/topology/render.rs (NEW)
render
```
...
- [ ] Substrate additions land in `crates/octo-network/src/topology/render.rs (NEW)` per RFC-0011-h §Substrate-Additions row G14
