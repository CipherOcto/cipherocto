...
Land RFC-0206 v2.1 §Adapter Crate List: 5 NEW per-owner adapter crates. Closes TV-0206-A6, TV-0206-A9(a), TV-0206-A10 gates. Per-adapter fixture suites (drop_table_negative + namespace_guard + 4 adversarial per RFC §Format Bypass Defense) are owned by `0206-010-per-adapter-fixtures`.
...
- RFC-0206 v2.1 §Adapter Crate List
- RFC-0206 v2.1 §Wiring Pattern (generic register helper form)
- RFC-0206 v2.1 §Cargo.toml Cross-Cuts lines 333-338 (REQUIRED `octo-storage-core` dep in adapter Cargo.toml)
- RFC-0206 v2.1 §Format Bypass Defense (adversarial fixtures — owned by 0206-010)
...
- RFC-0206 v2.1 (acceptance precondition per BLUEPRINT.md rule 5)
