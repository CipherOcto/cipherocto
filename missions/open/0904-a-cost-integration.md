...
- [ ] OCTO-W balance functions: `get_octo_w_balance(key_id: &[u8; 16]) -> Result<u64, StorageError>` and `deduct_octo_w(key_id: &[u8; 16], cost_amount: u64) -> Result<u64, StorageError>`
