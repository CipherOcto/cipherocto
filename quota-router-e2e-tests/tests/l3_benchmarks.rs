...
use quota_router::provider::{NetworkId, ProviderAuth, ProviderConfig, RouterNodeId};
...
fn l3_b6_select_destinations_benchmark() {
    use quota_router::provider::{ModelPricing, ProviderCapacity, ProviderHealth, ProviderId};
