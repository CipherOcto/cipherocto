...
> Forward-reference: see RFC-0960 §2 Specification for the vault-balance projection substrate (VaultBalanceProjection cache + producer trait) that mirrors this section's bounded-LRU pattern.
