...
/// **Wire form:** PascalCase verbatim (no `serde(rename_all = "snake_case")`)
/// — this matches the real source and TV-0957-02 byte-exact pin. If a future
/// revision introduces snake_case wire form, it MUST be a v3 RFC + migration.
