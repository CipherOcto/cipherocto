...
pub trait InteropPolicy: Send + Sync {
    ...
    // RFC-0959 v2.1 §2 BurnEventRef wire form does NOT define `carry_proof`. Earlier §1
    ...
    // substrate-side `struct SettlementEnvelope` (RFC-0959 v2.2-defined) DOES exist at
