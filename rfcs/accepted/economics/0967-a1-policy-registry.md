...
**Accepted (v1.6, 2026-08-22).** [R15 fix F-R15-FD-1 VERSION-DRIFT: front-matter v1.4 + §0 v1.1 + §5 v1.5 reconciled to v1.5 matching the §5 Version History latest row. v1.1 (2026-08-22 R2 initial filing) → v1.2 (R8 amendments) → v1.3 (R11 fresh) → v1.4 (R12 cross-RFC drift closure row in §5) → v1.5 (R12 fresh fix trail row in §5) → v1.6 (R15 F-R15-FD-1 + F-R15-FD-5b + F-R15-FD-2 cascade).]
