...
**Numbering scheme:** RFC-0015-a owns TV-WLT-AGT-3-11c (write path); RFC-0015 owns TV-WLT-AGT-1/2/12-23 (read path; sub-letter 13a-13h within `validate_reason`). Sub-letter scheme: `TV-<PREFIX>-<N><x>` denotes a sub-test variant of parent `TV-<PREFIX>-<N>`.
