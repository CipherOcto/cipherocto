...
pub struct NetworkGovernanceRotationOutput {
  pub has_quorum: bool,
  pub migration_deadline: Option<u64>, // epoch millis
...
RFC-0011-c/d/e/f/g all below slot 79; slots 79 + 82-90 free at Draft time. Per substrate-faithfulness audit 2026-09-18, slots 80 + 81 revert to candidate status if either substrate surface lands a fallible path in a future amendment (rationale in footnote [†] at the slot reservation rationale blockquote).
