...
| `crates/octo-cli/src/error.rs`                                | ADD 12 `OctoCliError` variants (slots 79-90; slots 80, 81, 89 RESERVED; `#[non_exhaustive]` additive) |
