...
| `slash mark`                   | (out of scope — CLI cannot mint SlashEnvelopes)                                                                                                                                                        | Substrate-only mint path; CLI cannot produce SlashEnvelopes. Operators calling pre-landing hit clap `UnrecognizedSubcommand` exit 2. Future amendment would need to extend RFC-0008 §Execution Class Mapping                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | RFC-0008 §RFC-0008 Execution Class Mapping                                                                        | (out of scope per RFC-0008 §Execution Class Mapping) | n/a   | n/a                 |
...
pub struct NetworkBindEnvelopeShowOutput {
    pub domain_id: String,                    // bind envelope domain identifier (canonical hex form; cross-ref §Output Field Validation)
...
- [ ] Mission `0011-h-network-peers-identity` (peers + identity)
  ...
  - [ ] 3 `OctoCliError` variants (NetworkConfirmRequired 87, NetworkDryRunDenied 88, NetworkCIRebindDenied 90)
- [ ] 6 Phase 4 test vectors (slots 87/88/90): rebind-prepare-3 (CI mode), rebind-prepare-4 (missing --confirm-acknowledge), rebind-commit-5 (CI mode), rebind-abort-3 (CI mode), rebind-abort-4 (missing --confirm-acknowledge), tv-network-dry-run-deny-1 (`NetworkPeerNotFound`, `NetworkLocalKeyUnavailable`, `NetworkInvalidDid`)
