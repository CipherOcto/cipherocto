...
- `SinkSpecific(String)` payload is facade-side scrubbed (defense-in-depth) before construction per `octo-audit` Layer B scrubber at `§octo-audit::scrub (facade scrubber)` per RFC-0012 §S5.1 canonical scrubber table
