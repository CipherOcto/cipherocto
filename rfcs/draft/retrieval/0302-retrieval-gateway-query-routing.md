# RFC-0302 (Retrieval): Retrieval Gateway & Query Routing

## Status

Draft

> **Note:** This RFC was renumbered from RFC-0113 to RFC-0302 as part of the category-based numbering system.
