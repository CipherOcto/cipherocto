# RFC-0304 (Retrieval): Verifiable Vector Query Execution (VVQE)
...
> **Note:** This RFC was renumbered from RFC-0150 to RFC-0304 as part of the category-based numbering system.
